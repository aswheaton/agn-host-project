...
\begin{figure}[h]
\centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_01_sfh.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_02_sfh.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_03_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_04_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_05_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_06_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_07_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_08_sfh.pdf}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_09_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.9\textwidth]{../pipes/plots/prior/phil_model_10_sfh.pdf}
  \caption{A priori and posterior SFH.}
  \label{}
\end{figure}
